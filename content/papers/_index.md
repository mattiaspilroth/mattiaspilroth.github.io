---
title: "Operational Resilience & OT Security"
---
...
**[Why OT Infrastructure Appears Static](/papers/why_ot_appears_static/)** Stability in continuous process industries is often an engineered response to asymmetric risk rather than technical stagnation. Examines validated configurations, lifecycle economics, vendor authority boundaries, and why ignoring these constraints leads to security strategies that cannot be sustained.

**[Silent Degradation Under IT/OT Convergence](/papers/silent_degradation_under_it_ot_convergence/)** Redundant IT infrastructure inside segmented OT zones can degrade invisibly when health signals do not reach actors with authority to intervene. The gap is often not the absence of signals, but the absence of a clearly defined owner for acting on them.

### Identity and Trust

**[OT Identity Architecture: Federation, PAM, and Residual Risk](/papers/ot_identity_architecture/)** A structural analysis of common identity models in OT. Explores how federation, isolation, and hybrid approaches redistribute rather than eliminate risk, and why authority for high-consequence actions must remain clearly defined.

**Part 1: [Trust Decay in Constrained OT Environments](/papers/trust_decay/)** Certificate validation assumes trust material is continuously obtainable. In segmented OT architectures, that assumption may not hold. Trust erosion can remain latent until operational stress reveals it.

**Part 2: [Trust Flow in Constrained OT Environments](/papers/trust_flow/)** Defines the properties required for validation to occur predictably and repeatedly inside constrained zones. Written as architectural requirements to prevent the failure modes identified in Part 1.

### Strategy and Governance

**[Compliance and Consequence: Competing Priorities in OT Security](/papers/compliance_and_consequence/)** Examines why compliance-driven programs and resilience-driven programs diverge over time. Analyzes the structural incentives behind that divergence and outlines what operationalizing consequence-oriented security requires.
